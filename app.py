...
class EmailApplication:
    ...
    def get_temp_info(self):
        template_info_path = self.conf.get_cfg("template", "file_name")
        wb = load_workbook(template_info_path)
        ws = wb.active
        self.temp_item = {}
    ...
    def __start(self):
        ...
        for email_, dis_, comp_exe in self.email_tasks:
            ...
            if file_info:
                ...
                file_list = []
            try:
                email_sender.email_send(title=title, receiver=receiver, sender=self.user_, tem_name=temp_num_,
